...
import com.jukusoft.mmo.engine.graphics.camera.impl.Shake1CameraModification;
import com.jukusoft.mmo.engine.graphics.camera.impl.Shake2CameraModification;
import com.jukusoft.mmo.engine.graphics.camera.impl.Shake3CameraModification;
import com.jukusoft.mmo.engine.utils.GameTime;
import com.jukusoft.mmo.engine.utils.MouseUtils;
...
public class CameraHelper implements ModificationFinishedListener {
    ...
    */
    public void update (GameTime time) {
        ...
        this.correctBounds(lastX, lastY);
    ...
    protected void updateMouseScrollCamera () {
    ...
    protected void correctBounds (float lastX, float lastY) {
